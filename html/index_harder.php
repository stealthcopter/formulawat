...
// Extra debugging to make it easier to understand what's happening with the formulas along the way
...
if (isset($_POST['submit'])) {
    ...
    elseif ($_POST['A'] == 0) {
        ...
        if (floatval($discriminant) == 0) {
            echo "Only 1 root, not interesting enough to calculate...". "<br>";
        }
        else {
